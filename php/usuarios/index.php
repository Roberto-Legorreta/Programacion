...
<body background="images/golf.jpg" style="background-attachment: fixed" >
	...
	<table border="0" align="center" valign="middle">
		...
		<tr><td><label style="font-size: 14pt"><b>Correo: </b></label></td>
			<td width=80> <input class="form-group has-success" style="border-radius:15px;" type="text" name="nick"></td></tr>
		<tr><td><label style="font-size: 14pt"><b>Contraseña: </b></label></td>
			<td witdh=80><input style="border-radius:15px;" type="password" name="pass1"></td></tr>
		<tr><td></td>
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input type="text" name="mail" class="form-control"  required placeholder="Ingresa mail"/>
	    ...
	    <div class="form-group">
      <label style="font-size: 14pt; color: #FFFFFF;"><b>Reingresa tu email</b></label>
      <input type="text" name="nick2" class="form-control"  required placeholder="Ingresa mail 2"/>
    </div>
    <div class="form-group">
